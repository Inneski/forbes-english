...
TOPICS = [
    ...
    dict(slug='ielts', name='IELTS Academic', short='IELTS',
         pattern=r'\bielts\b', page='ielts.html',
...
def hub_url(slug):
    """Where a topic's page lives. Most are generated by build_hubs.py;
    IELTS has its own landing page, ielts.html, built by build_ielts_hub.py."""
