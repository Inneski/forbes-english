...
sec('teach', B % 'bg34.jpg', 'right', 'top',
...
mc(2, 6, B % 'bg06.jpg', 'right', 'top', 'Choose the passive',
...
mc(5, 6, B % 'bg17.jpg', 'left', 'top', 'Ask the question',
...
mc(6, 6, B % 'bg30.jpg', 'right', 'top', 'Now, or in general?',
