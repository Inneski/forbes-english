...
/* A cover is a strip at the foot of the frame, centred, with the panel fading
   up out of the picture instead of sitting on it as a box. The plate is the
   title screen; this is the caption under it. */
.is-cover .zone{align-items:flex-end!important;justify-content:center!important}
...
.is-cover .cover-title{font-size:2.9cqw}
.is-cover .story{font-size:1.5cqw;max-width:46cqw}
