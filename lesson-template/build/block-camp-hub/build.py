...
ADVENTURES = [
 ...
 ('block-camp/frankenstein-green-prometheus-rpg.html','block-camp/frankenstein-green-prometheus-rpg/01_cover.webp','Frankenstein: The Green Prometheus',
  'Mary Shelley&rsquo;s laboratory rebuilt block by block. Six branching choices decide what the Creature becomes &mdash; whether Victor speaks or runs, keeps his promise or breaks it &mdash; and the last one asks Walton to choose between his crew and the glory that killed Victor.',
  ('Going To',),'A2','pro','new'),
 ('block-camp/last-bounty-rpg.html','block-camp/last-bounty-rpg/cover.webp','The Last Bounty',
 ...
 ('block-camp/fistful-of-lies-rpg.html','block-camp/fistful-of-lies-rpg/01_cover.webp','A Fistful of Lies',
