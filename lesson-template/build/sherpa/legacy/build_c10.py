...
sys.path.insert(0, 'lesson-template/build'); sys.path.insert(0, 'lesson-template/build/sherpa/legacy')
sys.path.insert(0, 'lesson-template/build/sherpa/legacy')
import camp_ten_diagram as D

BASE = open('lesson-template/build/sherpa/legacy/chassis-camp-seven.html', encoding='utf-8').read()
...
# ── Frozen 2026-09-22: the family is decks now (build_sherpa.py). This module
# keeps its helpers importable and runs its old build only when executed. ──
