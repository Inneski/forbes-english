# -*- coding: utf-8 -*-
"""Open Answer Practice (B2), second copy — rebuilt as a production deck.

This file is a duplicate of forbes-english-meetings.html: the same eight
scenarios, the same broken grading. Both URLs are live, so both are rebuilt
rather than one being left serving the old version. If one of them is to be
retired, this is the one to go — its filename carries spaces, which become
%20 in the URL.
...
OUT = 'forbes-english-ope- say in your words.html'
F = 'Meetings'
